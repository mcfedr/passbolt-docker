 ...
 */
	Configure::write('App.fullBaseUrl', getenv('PASSBOLT_APP_BASE'));
 ...
 */
	Configure::write('Security.salt', getenv('PASSBOLT_SECURITY_SALT'));

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', getenv('PASSBOLT_SECURITY_SEED'));
